...
<body>
    ...
    <nav class="navbar">
        ...
        <c:if test="${sessionScope.userId==null}">
            ...
            <a href="${url_login}"><i class="fas fa-sign-in-alt"></i> Login</a>
        ...
        <div class="login-container">
            ...
            <f:form action="${url_login}" modelAttribute="command">
                <div class="form-group">
                    ...
                    <f:input path="loginName" id="loginName" placeholder="Enter your username"/>
                </div>

                <div class="form-group">
                    <label for="password"><i class="fas fa-lock"></i> Password</label>
                    <f:password path="password" id="password" placeholder="Enter your password"/>
                </div>
